...
# MAGIC
# MAGIC We're building a random forest model to predict Airbnb listing prices.
...
# Register model
suffix = "AML" # Change for your initials
...
single_row_df = pd.DataFrame([[8.3252,	41.0,	6.984127,	1.023810,	322.0,	2.555556,	37.88,	-122.23]], columns=["MedInc", "HouseAge", "AveRooms","AveBedrms", "Population", "AveOccup", "Latitude", "Longitude"])
<FILL_IN>
