...
import os
bank_df = spark.read.option("header", True).option("inferSchema", True).csv("file:/Workspace/Users/alopezmoreno@mngenvmcap358061.onmicrosoft.com/databricks-training/Sesion 5/data/churn.csv")
display(bank_df)
