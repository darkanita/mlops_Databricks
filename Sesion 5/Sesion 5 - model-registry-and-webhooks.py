...
# MAGIC
# MAGIC - **Databricks Runtime**: This notebook is tested on Databricks Runtime for Machine Learning 12.2 LTS or above.
...
sorted_runs = mlflow.search_runs(experiment_details.experiment_id).sort_values("metrics.auc", ascending=False)
...
mlflow.search_runs(experiment_details.experiment_id)
...
model_uri = f"runs:/{best_run_id}/random_forest_classifier"
